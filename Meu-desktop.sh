...
case $opcao in
     1)
echo "Removendo snap..."
     # Este comando vai remover todo o suporte ao snap e instalar flatpak com o gnome-software.
     sleep $TIME
...
echo "Instalando suporte a flatpak..."
     # Este comando instala todas as dependências para o flatpak.
...
echo "Instalando programas essenciais..."
     # Este comando vai instalar programas essenciais no Ubuntu.
      ...
      clear
echo "Tudo pronto, agora vamos reiniciar o computador!"
